...
import br.com.fourward.cip.canonical.builder.PaymentFileCanonicalBuilder;
...
@Component
public class PaymentFileCanonicalConverter {

public PaymentFileCanonical convert(final PaymentEntity paymentEntity){
		...
		final Date date = paymentEntity.getDate();
		...
		return PaymentFileCanonicalBuilder 
				.create()
				.setId(id) 	
				.setExternalId(externalKey) 
