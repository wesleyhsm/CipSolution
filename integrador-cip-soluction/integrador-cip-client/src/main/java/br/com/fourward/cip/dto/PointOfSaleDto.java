...
public class PointOfSaleDto implements Serializable{
	...
	@NotNull(message="O nome do ponto de venda não pode ser nulo.")
	@Size(min=1, max=80, message="O nome do ponto de venda deve ter tamanho de 1 áte 80 caracteres.")
	private String name;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PointOfSaleDto other = (PointOfSaleDto) obj;
		if (bankAccount == null) {
